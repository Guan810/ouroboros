...
LLM_API_KEY = get_secret("LLM_API_KEY", required=True)
...
LLM_BASE_URL = get_cfg("LLM_BASE_URL", default=None, allow_legacy_secret=True)
...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="gpt-4o", allow_legacy_secret=True)
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="gpt-4o", allow_legacy_secret=True)
...
os.environ["LLM_API_KEY"] = str(LLM_API_KEY)
os.environ["OPENAI_API_KEY"] = str(OPENAI_API_KEY or LLM_API_KEY or "")
os.environ["ANTHROPIC_API_KEY"] = str(ANTHROPIC_API_KEY or "")
if LLM_BASE_URL:
    os.environ["LLM_BASE_URL"] = str(LLM_BASE_URL)
os.environ["GITHUB_USER"] = str(GITHUB_USER)
os.environ["GITHUB_REPO"] = str(GITHUB_REPO)
os.environ["OUROBOROS_MODEL"] = str(MODEL_MAIN or "gpt-4o")
os.environ["OUROBOROS_MODEL_CODE"] = str(MODEL_CODE or "gpt-4o")
if MODEL_LIGHT:
